...
$update = "UPDATE subjects SET menu_name='{$subject_name}' , position='{$position}' , visible='{$visiblity}' WHERE id = '{$id}'";
    ...
    <div class="main">
        ...
        <div class="page">
            ...
            <form action="edit_subject.php?subject=<?php echo current_subject('id') ?>" method="post">
                <p>
                    Subject Name : <input type="text" name="menu_name" value="<?php echo current_subject("menu_name")?>">
                </p>
                <p>
                    Position :
